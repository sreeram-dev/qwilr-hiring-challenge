...
class TestStage1(unittest.TestCase):
  ...
  def test_get_single_crops_counts(self):
    ...
    self.assertEqual(self.farm.get_counts(), [{ "cropName": "feta", "amount": 23 }])
  ...
  def test_get_multiple_same_crops_counts(self):
    ...
    self.assertEqual(self.farm.get_counts(), [{ "cropName": "hot dogs", "amount": 15 }])
